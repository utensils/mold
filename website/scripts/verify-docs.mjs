...
const ignoredEnvVars = new Set([
  ...
  // Hunyuan3D 2.1 shape/PBR executable-oracle and retained-output paths.
  // Every reader is inside a Rust test or a feature-gated qualification
  // harness; none is supported runtime configuration.
  'MOLD_HUNYUAN3D21_CHECKPOINT',
  'MOLD_HUNYUAN3D21_ORACLE',
  'MOLD_HUNYUAN3D21_RESULT',
  'MOLD_MATERIAL_BAKE_ORACLE',
  'MOLD_MATERIAL_BAKE_OUTPUT',
  'MOLD_MATERIAL_PROJECTION_TRACE',
  'MOLD_PAINT_APPEARANCE_IMAGE',
  'MOLD_PAINT_APPEARANCE_MODE',
  'MOLD_PAINT_ATTENTION_ORACLE',
  'MOLD_PAINT_ATTENTION_RESULT',
  'MOLD_PAINT_BLOCK_ORACLE',
  'MOLD_PAINT_BLOCK_RESULT',
  'MOLD_PAINT_CAMERA_ORACLE',
  'MOLD_PAINT_CAMERA_OUTPUT',
  'MOLD_PAINT_CAMERA_TRACE',
  'MOLD_PAINT_CONDITION_IMAGES',
  'MOLD_PAINT_CONV_ORACLE',
  'MOLD_PAINT_CONV_RESULT',
  'MOLD_PAINT_DINO_CHECKPOINT',
  'MOLD_PAINT_DINO_ORACLE',
  'MOLD_PAINT_DINO_RESULT',
  'MOLD_PAINT_IMAGES_OUTPUT',
  'MOLD_PAINT_PIPELINE_ORACLE',
  'MOLD_PAINT_PIPELINE_OUTPUT',
  'MOLD_PAINT_POSITIONS_CUDA',
  'MOLD_PAINT_PROJECTOR_ORACLE',
  'MOLD_PAINT_PROJECTOR_RESULT',
  'MOLD_PAINT_RELIABILITY_ORACLE',
  'MOLD_PAINT_RELIABILITY_OUTPUT',
  'MOLD_PAINT_RUNTIME_APPEARANCE',
  'MOLD_PAINT_RUNTIME_MESH',
  'MOLD_PAINT_RUNTIME_OUTPUT',
  'MOLD_PAINT_SAMPLER_ORACLE',
  'MOLD_PAINT_SPATIAL_ORACLE',
  'MOLD_PAINT_SPATIAL_OUTPUT',
  'MOLD_PAINT_UNET_ORACLE',
  'MOLD_PAINT_UNET_OUTPUT',
  'MOLD_PAINT_UNET_WEIGHTS',
  'MOLD_PAINT_UPSCALER_ORACLE',
  'MOLD_PAINT_UPSCALER_OUTPUT',
  'MOLD_PAINT_UPSCALER_SCALARS',
  'MOLD_PAINT_UPSCALER_WEIGHTS',
  'MOLD_PAINT_UPSCALE_ALBEDO_ORACLE',
  'MOLD_PAINT_UPSCALE_MR_ORACLE',
  'MOLD_PAINT_UPSCALE_OUTPUT',
  'MOLD_PAINT_UV_ORACLE',
  'MOLD_PAINT_UV_OUTPUT',
  'MOLD_PAINT_UV_TRACE',
  'MOLD_PAINT_VAE_CHECKPOINT',
  'MOLD_PAINT_VAE_ORACLE',
  'MOLD_PAINT_VAE_RESULT',
