...
| Generate         | Capability-driven image/video controls, review-first prepared expansion batches, estimates             | Same exact-N, frozen-host review lifecycle and independent siblings, optimized for touch                                            |
| Gallery          | Unified local/remote grid with host filters, deduplication, batch provenance, and desktop file actions | Merged saved-host gallery with batch/source provenance, full-screen image/video, swipe navigation, Use as prompt, and Use as source |
