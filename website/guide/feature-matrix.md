...
| Settings  | Jump nav + search over the same sixteen sections as desktop (Cloud GPUs and Per-style defaults included), rows save on change, `?section=` deep links                                          | Six Mold Studio themes with Match phone, remote-host shortcut, version, and TestFlight update channel                                                                                                                                                                                                            |
