...
| Chains and cloud | Guided Sequence plus TOML chain authoring/full jobs administration (inside Create), and RunPod provisioning (inside Machines)                              | Guided Sequence authoring with exact-host durable recovery; no TOML editor, full jobs administration, or RunPod workspace           |
