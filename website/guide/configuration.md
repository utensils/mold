...
| `MOLD_ARTIFACT_ATTESTATIONS_DIR`  | `$MOLD_HOME/.artifact-attestations-v1` | Owner-private durable digest attestations for pinned model artifacts; set this to private service state when `MOLD_HOME` is shared or group-writable                                                                                                                                                                                                                                 |
