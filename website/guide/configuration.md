...
| `MOLD_ZIMAGE_GGUF_DENSE`              | off                                     | **Currently non-functional** ([#1109](https://github.com/utensils/mold/issues/1109)): the variable is not registered in the admission-frozen runtime environment, so it always reads as unset. Its documented intent — dequantize a GGUF Z-Image checkpoint into a dense parameter map at load — stays disabled until memory admission budgets the dense expansion (a 3.4 GB Q4_K file becomes ~12 GB on CUDA / ~24 GB on Metal).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
