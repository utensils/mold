...
| `MOLD_WAN_STEP_PROFILE`               | off                                     | Diagnostic ([#775](https://github.com/utensils/mold/issues/775)): `1` prints one per-phase, device-synced timing line per Wan denoise step (self/cross attention, ffn, quantized matmuls, casts). The syncs inflate wall time, so use this for auditing, never production.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `MOLD_THUMBNAIL_WARMUP`             | --                  | `0` to skip prebuilding gallery thumbnails at server startup (default: enabled; renders newest-first on a bounded thread pool, then sweeps tiles of purged prints)                                                                                                                                                                                                                                                                                                                                        |
...
because their engines don't yet split encoder/transformer/VAE across devices. Setting
