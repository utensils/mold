...
| `MOLD_ATTN`                           | `math`                                  | Attention backend: `math` (default) or `flash` (needs a build with `--features cuda,flash-attn`; falls back to math with a one-shot warning otherwise)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
