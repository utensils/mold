...
| `MOLD_VAE_TILED`                      | `auto`                                             | Tiled VAE decode for FLUX/FLUX2/SDXL/SD3 and Z-Image on Metal: `auto` retries with tiling on OOM, `force` always tiles, `off` disables. Z-Image’s proactive Metal span cap still applies                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
