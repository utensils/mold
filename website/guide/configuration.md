...
| `MOLD_OFFLOAD`            | —                                       | `1` to force adaptive block offload for FLUX, Flux.2, Z-Image, Qwen-Image, and SD3 BF16 paths. FLUX / Flux.2 / Z-Image / Qwen-Image keep fitting blocks GPU-resident and stream only overflow blocks; SD3 still full-streams.                                                                                                                                                                                                                                                                                 |
