...
| `MOLD_OFFLOAD_PREFETCH`               | `on`                                    | Block-offload upload overlap — FLUX's prefetch stream and Qwen-Image's streamed-block double buffering; set `off` to revert to synchronous                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
