...
| `MOLD_ZIMAGE_GGUF_DENSE`              | off                                     | `1` dequantizes a GGUF Z-Image checkpoint into a dense parameter map at load instead of the default quantized runtime. The quantized path is the default because the dense map inflates a 3.4 GB Q4_K file to ~24 GB resident on Metal (F32) and caused silent render corruption there; the dense map may still be faster on CUDA (BF16, ~12 GB), which is unmeasured.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
