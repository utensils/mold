...
If a host cannot apply what you filed because it is running without a metadata
database, or because the collection went away between listing it and pressing
Generate, the print is still rendered and saved, and the TUI says what was dropped: a
