...
mold library export <FILENAME.glb> --format gif|apng|webp [--playback loop|bounce] [--repeat forever|once] [--max-dimension 240..2160] [--frames 8..180] [--fps 1..30] [-o PATH | --output -]
