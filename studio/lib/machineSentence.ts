...
import { inferBackendFromGpuName } from "./hostRouting";
 ...
 * long it has been up. The Machines list and the machine pane both say it, on
 * every shell, so a 4× L40S box can never read as one card in one place and
 * four in the other.
 */
