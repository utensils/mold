...
- LTX-2 output up to 4K by composition — stage 1 at half size, a learned x2
  upsample, then a tiled stage-2 refinement — with a 1280x704 → 4096x2176
  ladder and portrait transposes. Above 1080p is unqualified on consumer
  GPUs; see [the resolution notes](https://utensils.io/mold/models/ltx2#resolution)
