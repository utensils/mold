...
- **Organized Library**: title, favorite, tag, and collect prints, with a
  per-host trash and configurable retention — merged across machines in the
  web and desktop Library (Prints | Collections | Trash)
