...
| `MOLD_OFFLOAD_PREFETCH`               | `on`                              | Block-offload upload overlap: FLUX prefetch stream + Qwen-Image streamed-block double buffering (`off` reverts to synchronous)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
