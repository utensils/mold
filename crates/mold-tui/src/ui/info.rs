//! Resource telemetry state shared by the chrome host chip, status
//! polling, and the Machines workspace. The Create view's Info
//! sub-panel was retired in the Create redesign — telemetry lives in
//! Machines and the chrome; the model description renders as a dim
//! line under the Model row.
