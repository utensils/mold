...
fn pipeline_phase_name(phase: H3PipelinePhase) -> &'static str {
    match phase {
        ...
        H3PipelinePhase::VaeLoad => "Loading MiniMax H3 visual and audio VAEs",
        H3PipelinePhase::VaeLoadChunk => "Loading MiniMax H3 VAE component",
        ...
        H3PipelinePhase::QwenLoad => "Loading MiniMax H3 Qwen conditioner",
        ...
        H3PipelinePhase::TransformerLoad => "Loading MiniMax H3 streamed transformer",
