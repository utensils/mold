...
- **LTX-2 devshell helpers**: the flake devshell now includes the native LTX-2 workflow helpers `build-ltx2`, `test-ltx2`, `smoke-ltx2`, `contact-sheet`, and `issue-note`, plus the repo tools needed to run them.
