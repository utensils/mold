...
- **CI:** `.github/workflows/desktop.yml` runs desktop frontend formatting/type/tests and the macOS Rust fmt/clippy/test/bundle gates for desktop-relevant pushes and pull requests. The desktop cargo root remains excluded from the workspace CI.
