 ...
 * submitted still-live job when Create is using Auto or Most capable, else the
 * primary. A concrete sticky selection is resolved by the status component
 * before this fallback. Jobs without a routed host run on the primary.
 */
