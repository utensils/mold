...
const UNCONVERTED: Record<string, number> = {
  ...
  "../ui/components/ShapePicker.vue": 1,
  "../ui/components/SheetPanel.vue": 5,
  "../ui/components/Stepper.vue": 2,
  "../ui/components/ToastShelf.vue": 4,
  "../ui/components/Tooltip.vue": 2,
  "../ui/components/UpscaleDialog.vue": 5,
  "../ui/components/VideoExportDialog.vue": 4,
  "../studio/components/ImageDropWell.vue": 3,
  "../studio/components/MeshViewer.vue": 2,
  "../studio/components/MinimaxH3AuthoringPanel.vue": 4,
  "../studio/components/MinimaxH3InventoryPanel.vue": 5,
  "../studio/components/NotificationsCenter.vue": 14,
  "../studio/components/QueueEntryDetail.vue": 4,
  "../studio/components/QueuePlanWorkList.vue": 2,
  "../studio/components/ReferenceCropEditor.vue": 2,
};
