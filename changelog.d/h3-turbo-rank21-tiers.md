- **Three rank-21 MiniMax H3 Turbo tiers.**
  ...
  VRAM); they are lossy low-rank approximations of the reviewed adapters, and
  the measured A/B against each full-rank source tier is recorded in
  `docs/qualification/minimax-h3.md` (visual parity on all six pairs, 1.5-1.6
  GB less VRAM measured, PSNR 21-29 dB on the FL2VA pairs and 16-17 dB on the
  panning Ref2VA pair)
