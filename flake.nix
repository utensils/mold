    ...
    inputs.flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      perSystem =
        ...
        let
          ...
          devFeatures = if gpuFeature != "" then "${gpuFeature},preview,discord,expand" else "preview,discord,expand";
          ...
          mold = craneLib.buildPackage (
            ...
            // {
              ...
              cargoExtraArgs =
                "-p mold-ai --features preview,discord,expand" + lib.optionalString (gpuFeature != "") ",${gpuFeature}";
              postInstall = ''
