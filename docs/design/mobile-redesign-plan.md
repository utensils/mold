...
Mesh/PBR generation and user physical iPhone verification remain separate open gates. Evidence screenshots are retained under the external volume's `build/mobile-redesign-evidence` directory.
