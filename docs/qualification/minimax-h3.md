...
- Evidence snapshot: **2026-08-07, Mold main `b5ea538a`**
...
Accordingly, no H3 weights, production safetensors header ranges, generated
media, or real-checkpoint UAT were downloaded, read, executed, or retained for
the work recorded here. The planned external-volume UAT home was not used for
H3 artifacts.
...
| Pending review               | Web, desktop, and iPhone authoring, gated inventory/readiness, durable draft media, canonical reference-upload probing, exact recovery identity, and closing-frame provenance                                                                                                         | [#867](https://github.com/utensils/mold/pull/867), exact pending snapshot `5e2bfd981bd4bc2c79e5987c0c32abeac491c66b`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | No qualification effect unless merged; even when merged, the UI remains fail closed while runtime capability is unavailable |
| Stacked and pending          | CLI, TUI, and Discord ordered-reference authoring and media provenance                                                                                                                                                                                                                | [#868](https://github.com/utensils/mold/pull/868), stacked snapshot `4deb1fe56ce17398cabc2a9e8f16eade56f70a52`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | No qualification effect unless rebased, reviewed, and merged; no runtime activation                                         |
| Local release candidate only | Isolated H3 FlashAttention feature, synthetic qualification probe, CI contract, and explicit release-binary exclusion                                                                                                                                                                 | `perf/h3-attention-release-candidate` at `0204e9d983098a4c8dfc196e42dd1d87d2ee8994`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Not merged, not compiled into a published Mold binary, and not real H3 UAT                                                  |
...
The sizes below come from the hidden, revision-locked file manifests in
`mold-core::minimax_h3`. They are planning facts, not evidence that any file
was downloaded.
...
and model-download volume and reported roughly 1 TB free. It is not currently a
qualified storage target. A bounded create/fsync/read/checksum/delete probe did
not complete, and subsequent filesystem commands against the volume also hung.
The volume is therefore excluded from Mold UAT until separately authorized
repair or remount work is complete and the clean-storage gate below passes.

No H3 model download, `MOLD_HOME`, fixture bundle, checkpoint header, generated
output, or other H3 artifact was placed on that volume. The storage failure is
independent of the license restriction: fixing the volume would not authorize
H3 artifact access or execution.
...
| CUDA full attention | [PR #857](https://github.com/utensils/mold/pull/857) records 121 synthetic H3 tests on the Plato host (4× L40S, SM89, CUDA 12.8), including BF16 dense-reference-to-FlashAttention-v2 parity. The unmerged candidate `0204e9d9` separately passed 141 synthetic tests, compiled 53 compute-89 FlashAttention-v2 objects, and exercised a live 257-row BF16 56×128 dispatch shape in 4,745 microseconds with maximum absolute delta `0.000488` against a `0.02` bound. Its linear LSE auxiliary accounting was 8.35 MB at 37,296 rows and 24.16 MB at 107,856 rows, with zero bytes of quadratic score/probability tensor allocation.                       | Synthetic development evidence only; the candidate is release-excluded and these measurements do not establish real-model correctness, quality, peak memory, or throughput |
...
| Studio surfaces     | PR #867 has exact-head local frontend, server-upload, MP4/AAC probe, formatting, and warnings-denied clippy evidence; it was still pending review/CI at this snapshot                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Authoring and recovery contracts only; gated readiness cannot make the runtime available                                                                                   |
| CLI/TUI/Discord     | PR #868 has weight-free surface tests on its stacked snapshot and was still pending rebase/review at this snapshot                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Authoring and provenance contracts only; no runtime activation                                                                                                             |
